...
var engine, world;
var ball,ground,string,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15,b16,b17,b18,b19,b20;

function setup(){
    var canvas = createCanvas(1600,700);
    engine = Engine.create();
    world = engine.world;
    ball = new Ball(200,400,70,70);
...
string = new SlingShot(ball.body,{x:400,y:50})
}
